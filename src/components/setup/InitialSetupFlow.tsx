        ...
        return (
          <div key={model.id} className="bg-card rounded-xl border p-4 shadow-sm">
            <div className="flex items-start justify-between gap-3">
              ...
              {isActive ? (
                <Badge variant="outline" className="shrink-0 border-green-500 text-green-400">
            ...
            <div className="mt-4 flex flex-wrap gap-2">
              <Button
                ...
                <span className="hidden sm:inline">{t('setup.model.test')}</span>
              </Button>
              <Button size="sm" variant="outline" onClick={() => onEdit(model)} className="gap-1.5">
                <Edit className="h-3.5 w-3.5" />
                <span className="hidden sm:inline">{t('models.editButton') || 'Edit'}</span>
              </Button>
              <Button
                size="sm"
                variant="destructive"
                ...
                <span className="hidden sm:inline">{t('models.deleteModel') || 'Delete model'}</span>
              </Button>
            </div>
          </div>
        )
